...
import random
from Auxiliares import ex
from Auxiliares import inverso
from Auxiliares import mcd
...
if __name__ == '__main__':
    ...
    while True:
        ...
        p = number.getPrime(330)
        q = number.getPrime(330)

        # Dejamos de generar hasta que sean dos primos diferentes
        if p != q:
            break
